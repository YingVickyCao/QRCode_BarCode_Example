...
public class QRCodeUtil {
    public static void generateQRCodeImage(String text, int width, int height, String filePath) throws WriterException, IOException {
        ...
        BitMatrix bitMatrix = qrCodeWriter.encode(text, BarcodeFormat.QR_CODE, width, height, createHints());
    ...
    private static Hashtable createHints() {
    ...
    public static void generateQRCodeImage2(String text, int width, int height, String filePath) throws WriterException, IOException {
        QRCodeWriter qrCodeWriter = new QRCodeWriter();
        BitMatrix byteMatrix = qrCodeWriter.encode(text, BarcodeFormat.QR_CODE, width, height, createHints());
